      ...
      <div class="side-info-panel">
        ...
        <div class="plc-info-section">
          <div class="section-header">
            <span class="section-title-text">当前扫码包裹信息</span>
          </div>
        ...
        <div class="operation-panel">
          <div class="section-header">
            <span class="section-title-text">操作区</span>
            <el-button
              type="primary"
              size="mini"
              icon="el-icon-search"
        ...
        <div class="log-section">
          <div class="section-header">
            <span class="section-title-text">日志区</span>
            <div class="log-tabs">
              <div
                class="log-tab"
        ...
        <div class="floor-container">
          ...
          <div class="floor-left">
            <div class="floor-title">
              <span class="floor-title-main">
                <i class="el-icon-office-building"></i> 作业区域
              </span>
              <span class="floor-legend">
                <span class="legend-item"
                  ><i class="legend-dot legend-dot--photo"></i>光电</span
                >
                <span class="legend-item"
                  ><i class="legend-dot legend-dot--motor"></i>电机</span
                >
                <span class="legend-item"
                  ><i class="legend-dot legend-dot--queue"></i>队列</span
                >
              </span>
            </div>
...
.smart-workshop {
  --mp-accent: #e8952e;
  --mp-accent-bright: #ffc861;
  --mp-accent-dim: rgba(232, 149, 46, 0.14);
  --mp-accent-glow: rgba(232, 149, 46, 0.35);
  --mp-accent-soft: rgba(232, 149, 46, 0.12);
  --mp-secondary: #6b9def;
  --mp-secondary-bright: #8bb4ff;
  --mp-panel-bg: #121828;
  --mp-panel-bg-2: #1a2238;
  --mp-panel-border: rgba(232, 149, 46, 0.18);
  --mp-text: #eae6df;
  --mp-text-muted: rgba(196, 190, 180, 0.72);
  --mp-danger: #e85563;
  --mp-warning: #e8952e;
  --mp-stop: #d94050;
  --mp-success: #3dba6e;
  ...
  background: radial-gradient(
      ...
      rgba(232, 149, 46, 0.09) 0%,
      transparent 55%
    ),
    radial-gradient(
      ellipse 55% 45% at 88% 92%,
      rgba(107, 157, 239, 0.06) 0%,
      transparent 50%
    ),
    linear-gradient(165deg, #0a0d14 0%, #121620 42%, #1c2333 100%);
  position: relative;
  display: flex;
  ...
  &::before {
    ...
    background-image: linear-gradient(
        rgba(232, 149, 46, 0.025) 1px,
        transparent 1px
      ),
      linear-gradient(90deg, rgba(232, 149, 46, 0.025) 1px, transparent 1px);
    ...
    .side-info-panel {
      ...
      .operation-panel {
        ...
        .section-header {
          ...
          margin-bottom: 8px;
          padding-bottom: 10px;
          border-bottom: 1px solid rgba(232, 149, 46, 0.12);
          ...
          .el-button:hover {
            background: rgba(232, 149, 46, 0.28);
        ...
        .scrollable-content {
          .status-overview {
            ...
            .data-card-border {
              ...
              background: linear-gradient(
                135deg,
                rgba(28, 34, 52, 0.95) 0%,
                rgba(38, 46, 68, 0.9) 100%
              );
            ...
            .data-card-border-borderDown {
              font-family: 'Consolas', 'JetBrains Mono', 'SFMono-Regular',
                monospace;
              font-weight: 600;
              color: #fff;
              text-align: left;
      ...
      .log-section {
        ...
        .section-header {
          ...
          .log-tab {
            ...
            .alarm-badge {
              ...
              top: -6px;
              right: -4px;
              background: linear-gradient(135deg, #ff6b7a, #e74c5e);
              color: #fff;
              font-size: 11px;
              padding: 1px 5px;
              border-radius: 10px;
              ...
              align-items: center;
              justify-content: center;
              box-shadow: 0 2px 6px rgba(231, 76, 94, 0.45);
            }
          }
          ...
          .log-tab.active {
            ...
            box-shadow: 0 0 10px rgba(232, 149, 46, 0.15);
          }
        ...
        .scrollable-content {
          ...
          .log-list {
            ...
            .log-item:hover {
              ...
              border-left-color: rgba(232, 149, 46, 0.4);
            }
        ...
        .scrollable-content::-webkit-scrollbar-thumb:hover {
          background: rgba(232, 149, 46, 0.4);
        }
      }
      .operation-panel {
        .operation-buttons {
          ...
          .op-btn {
            ...
            background: linear-gradient(180deg, #3a4558 0%, #2e3848 100%);
            ...
            &:hover {
              background: linear-gradient(180deg, #445268 0%, #364052 100%);
              border-color: #627088;
            }
          ...
          .op-btn--start.pressed {
            border-color: rgba(61, 186, 110, 0.45);
          ...
          .op-btn--stop {
            border-color: rgba(180, 90, 98, 0.45);
            ...
            &:hover {
              border-color: rgba(200, 100, 108, 0.55);
            }
      ...
      .floor-container {
        ...
        .floor-left {
          .floor-image-container {
            ...
            align-items: center;
            justify-content: center;
            border: 1px solid rgba(232, 149, 46, 0.12);
            min-height: 0;
            ...
            .image-wrapper {
              ...
              .marker.scanning::before {
                ...
                animation: mp-signal-pulse 1.2s ease-in-out infinite;
              }

              @keyframes mp-signal-pulse {
                0%,
                100% {
              ...
              .marker-with-panel {
                ...
                .data-panel {
                  ...
                  border: 1px solid rgba(107, 157, 239, 0.3);
                  border-radius: 8px;
                  padding: 12px;
                  width: 170px;
                  ...
                  .data-panel-header {
                    ...
                    margin-bottom: 6px;
                    padding-bottom: 6px;
                    border-bottom: 1px solid rgba(107, 157, 239, 0.2);
                  }
                  .data-panel-content {
                    font-size: 12px;
                    .data-panel-row {
                    ...
                    .checkbox-group
                      ...
                      background-color: #e8952e; /* 选中时背景色 */
                      border-color: #e8952e; /* 选中时边框色 */
                    }
                  }
                }
              ...
              .preheating-room-marker {
                ...
                transform: translate(-50%, -50%);
                z-index: 10;
                background: linear-gradient(135deg, #4a6db8 0%, #1a2238 100%);
                border-radius: 5px;
          ...
          .floor-title {
            ...
            .floor-legend {
              ...
              .legend-dot {
                ...
                &--queue {
                  background: rgba(107, 157, 239, 0.85);
                  box-shadow: 0 0 6px rgba(107, 157, 239, 0.4);
                }
              }
            }
          }
          .floor-image-container {
            .image-wrapper {
              .queue-marker {
                ...
                background: linear-gradient(
                  135deg,
                  rgba(14, 35, 55, 0.92) 0%,
                  rgba(24, 50, 78, 0.88) 100%
                );
                padding: 5px 10px;
                border-radius: 6px;
                border: 1px solid rgba(107, 157, 239, 0.45);
                transition: all 0.25s ease;
                min-width: 44px;
                text-align: center;
              ...
              .queue-marker:hover {
                background: linear-gradient(
                  135deg,
                  rgba(24, 61, 97, 0.95) 0%,
                  rgba(32, 72, 110, 0.92) 100%
                );
                border-color: rgba(94, 179, 255, 0.7);
                box-shadow: 0 4px 14px rgba(0, 0, 0, 0.4),
                  0 0 12px rgba(107, 157, 239, 0.2);
                transform: translate(-50%, -50%) scale(1.04);
              }

              /* 特殊队列标记样式 - 上货1、上货2、缓存区1、缓存区2 */
              .special-queue {
                background: rgba(107, 157, 239, 0.9) !important;
                border: 1px solid rgba(107, 157, 239, 0.7) !important;
              }
              ...
              .special-queue:hover {
                background: rgba(107, 157, 239, 0.95) !important;
                border-color: rgba(139, 180, 255, 0.8) !important;
              }
  ...
  .side-info-panel-queue {
    ...
    .queue-section {
      background: linear-gradient(
        145deg,
        rgba(20, 32, 48, 0.97) 0%,
        rgba(28, 42, 58, 0.95) 100%
      );
      border-radius: 12px;
            ...
            .selected-queue-header {
              ...
              .queue-header-actions {
                ...
                .el-button:hover:not(:disabled) {
                  background: rgba(232, 149, 46, 0.3);
                  border-color: rgba(232, 149, 46, 0.5);
                  color: #fff;
                }
                .tray-total {
    ...
    .queue-section:not(.expanded) {
      ...
      .section-header {
        ...
        height: 40px;
        border-radius: 10px;
        background: linear-gradient(145deg, #e8952e 0%, #b8720e 100%);
        display: flex;
        align-items: center;
        justify-content: center;
        cursor: pointer;
        box-shadow: 0 4px 14px rgba(232, 149, 46, 0.35),
      ...
      .section-header:hover {
        ...
        background: linear-gradient(145deg, #ffc861 0%, #c4821a 100%);
        box-shadow: 0 6px 18px rgba(232, 149, 46, 0.45);
      }
    }
  }
...
.test-toggle-btn {
  ...
  height: 40px;
  border-radius: 10px;
  background: linear-gradient(145deg, #5a6a7e 0%, #3a4555 100%);
  display: flex;
  align-items: center;
  justify-content: center;
  cursor: pointer;
...
.test-toggle-btn:hover {
  transform: translateY(-2px);
  background: linear-gradient(145deg, #6e8098 0%, #4a5668 100%);
...
.test-panel-content::-webkit-scrollbar-thumb:hover {
  background: rgba(232, 149, 46, 0.5);
}
...
.cart-position-slider :deep(.el-slider__button:hover) {
  border-color: #e8952e;
  box-shadow: 0 0 5px rgba(232, 149, 46, 0.5);
}
  ...
  .quantity-buttons {
    ...
    .quantity-btn {
      ...
      &.plus {
        background: rgba(232, 149, 46, 0.5);
        &:hover {
          background: rgba(232, 149, 46, 0.7);
        }
      }
